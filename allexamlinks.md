...
This list contains all the bits of the documentation referenced in the exam questions for AZ-104 AZ-303 and AZ-304
The same lists are in each exam folder but this master list has had the duplicates removed.
...
https://docs.microsoft.com/en-us/powershell/module/servicemanagement/azure/set-azurestaticvnetip?view=azuresmps-4.0.0
